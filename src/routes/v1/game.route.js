 ...
 *     description: Only admins can create other games.
 *     tags: [Games]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Only admins can retrieve all games.
 *     tags: [Games]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   get:
 *     summary: Get a game
 *     description: Logged in games can fetch only their own game information. Only admins can fetch other games.
 *     tags: [Games]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in games can only update their own information. Only admins can update other games.
 *     tags: [Games]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in games can delete only themselves. Only admins can delete other games.
 *     tags: [Games]
 *     security:
 *       - bearerAuth: []
 *     parameters:
